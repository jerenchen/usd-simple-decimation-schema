...
An example API schema with Hydra 2.0 implementation of a simple mesh decimation [USD](https://github.com/PixarAnimationStudios/OpenUSD) plugin using [libigl](https://github.com/libigl/libigl).
